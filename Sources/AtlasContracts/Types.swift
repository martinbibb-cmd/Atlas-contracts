...
///
/// This type represents **only** the geometry and scan metadata produced by the
...
/// tagged objects, etc.) belong on ``VisitCapture``, not here.  Keeping this
/// type focused on raw scan geometry ensures the contract boundary remains clear.
///
